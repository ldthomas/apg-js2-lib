...
//	var utils = require("./utilities.js");
	...
	var clear = function(){
		totals = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.ALT] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.CAT] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.RNM] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.UDT] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.REP] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.AND] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.NOT] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.TLS] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.TBS] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	stats[id.TRG] = {empty: 0, match: 0, nomatch: 0, total: 0};
    	ruleStats.length = 0;
        for(var i = 0; i < rules.length; i+=1){
            ruleStats.push({empty: 0, match: 0, nomatch: 0, total: 0, name: rules[i].name, lower: rules[i].lower, index: rules[i].index});
        }
        if(udts.length > 0){
        	udtStats.length = 0;
            for(var i = 0; i < udts.length; i+=1){
                udtStats.push({empty: 0, match: 0, nomatch: 0, total: 0, name: udts[i].name, lower: udts[i].lower, index: udts[i].index});
            }
        }
    };
